    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!--
            报错：Cannot read properties of undefined (reading '1')
            原因：goods 的初始值为 {}
            解决办法：
              - 1.可选链 ?.
              - 2.v-if
          -->
          <el-breadcrumb-item :to="{ path: `/category/${goodsInfo.categories?.[1]?.id}` }">
            {{ goodsInfo.categories?.[1]?.name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/sub/${goodsInfo.categories?.[0]?.id}` }">
